...
class MenuVCTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.text = menuItems.names[row]
        cell.show(isSpecial: menuItems.specials[row], price: menuItems.price[row])
